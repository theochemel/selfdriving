...
let pipeline = [
    PipelineElement(name: "Get Frame", description: "...", shortDescription: "Lorem ipsum dolor sit amet"),
    PipelineElement(name: "Grayscale Conversion", description: "...", shortDescription: "Converts a color image to grayscale for faster processing"),
    PipelineElement(name: "Canny Edge Detection", description: "...", shortDescription: "A multi-step process for finding the edges in an image"),
]

let navigationBar = NavigationBar(forPipeline: pipeline)

liveView.addSubview(navigationBar)

NSLayoutConstraint.activate([
    navigationBar.leadingAnchor.constraint(equalTo: liveView.leadingAnchor),
    navigationBar.trailingAnchor.constraint(equalTo: liveView.trailingAnchor),
    navigationBar.topAnchor.constraint(equalTo: liveView.topAnchor),
